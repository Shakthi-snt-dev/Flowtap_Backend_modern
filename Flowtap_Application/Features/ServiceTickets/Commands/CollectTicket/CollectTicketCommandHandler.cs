...
namespace Flowtap_Application.Features.ServiceTickets.Commands.CollectTicket;

public class CollectTicketCommandHandler(IApplicationDbContext db, IDateTimeService dateTime)
