...
public static class RepairShopMobileSeeder
{
    ...
    private static void SeedServiceCategories(IApplicationDbContext context, Guid companyId)
    {
        // --- Hardware Issues ---
    ...
    private static async Task SeedDeviceBrandsAndModelsAsync(IApplicationDbContext context, CancellationToken ct)
    {
        // Apple
    ...
    private static async Task<DeviceBrand> GetOrCreateBrandAsync(IApplicationDbContext context, string name, CancellationToken ct)
    {
    ...
    private static async Task AddModelsAsync(IApplicationDbContext context, DeviceBrand brand, IEnumerable<string> modelNames, CancellationToken ct)
    {
