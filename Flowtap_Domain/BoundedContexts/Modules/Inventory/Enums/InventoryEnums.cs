...
public enum InventoryTransactionType
{
    ...
    Adjustment = 5, PurchaseReturn = 6, WriteOff = 7, SaleReturn = 8
}

public enum InventoryWriteOffType { Damaged = 1, Scrap = 2, Expired = 3 }

public enum ProductKind { Device = 1, Accessory = 2, SparePart = 3 }

public enum ProductPublishStatus { Draft = 1, Published = 2, Archived = 3 }

public enum StockAdjustmentReason
{
    VendorDelivery = 1, Damage = 2, Loss = 3, Correction = 4, Return = 5, Audit = 6
}
...
public enum WarehouseType { None = 0, InStore = 1, LocationWarehouse = 2, CentralWarehouse = 3 }
